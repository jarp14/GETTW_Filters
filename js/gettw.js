	...
	$(go.Palette, "divPalette",
		{
			...
			model: new go.GraphLinksModel([  // contenidos de la paleta
					...
					{ text: "w[n]", category: "textblock" },
					{ text: "a", subindex: "0", category: "textblock_subindex" },
					{ text: "b", subindex: "0", category: "textblock_subindex" }
				], [ 
					// enlaces
					...
					{ points: new go.List().addAll([new go.Point(0, 0), new go.Point(50, 0)]), strokeDashArray: [3, 3], linkStrokeColor: "black", linkStrokeWidth: "2", 
						fromArrowShape: "", fromArrowColor: "black", fromArrowStrokeColor: "black", fromArrowStrokeWidth: "2", 
						toArrowShape: "", toArrowColor: "white", toArrowStrokeWidth: "2", dash: "Dash Line", category: "link" },
					{ points: new go.List().addAll([new go.Point(0, 0), new go.Point(50, 0)]), linkStrokeColor: "black", linkStrokeWidth: "2", 
						fromArrowShape: "", fromArrowColor: "black", fromArrowStrokeColor: "black", fromArrowStrokeWidth: "2", 
						toArrowShape: "Triangle", toArrowColor: "black", toArrowStrokeWidth: "2", category: "link" }, 
				]
			)
		}
	);
